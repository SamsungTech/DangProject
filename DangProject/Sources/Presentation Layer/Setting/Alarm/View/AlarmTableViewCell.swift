...
extension AlarmTableViewCell {
    ...
    private func setUpAlarmSwitch() {
        ...
        NSLayoutConstraint.activate([
            isOnSwitch.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -xValueRatio(20)),
            isOnSwitch.topAnchor.constraint(equalTo: contentView.topAnchor, constant: yValueRatio(20))
        ])
    }
...
extension AlarmTableViewCell {
    private func setUpItemTextColorTrue() {
        ...
        self.downArrowButton.tintColor = .white
    }
    ...
    private func setUpItemTextColorFalse() {
        ...
        self.downArrowButton.tintColor = .lightGray
    }
